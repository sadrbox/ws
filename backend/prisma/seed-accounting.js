...
export const KZ_CHART_OF_ACCOUNTS = [
	...
	// Уставный капитал. Для ТОО по типовому плану счетов РК это 5030 «Вклады и паи»
	// (5010/5020 — акции, они для АО). Без него вводить входящие остатки не на что:
	// деньги и товары на начало периода должны иметь источник, иначе актив приходит
	// «из воздуха» и касса с банком уходят в минус.
	{ code: "5030", name: "Вклады и паи (уставный капитал)", accountType: "passive" },
