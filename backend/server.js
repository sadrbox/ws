...
import objectMarksRouter from "./api/router/objectMarks.js";
import todoStatusesRouter from "./api/router/todostatuses.js";
...
import fixedAssetsRouter from "./api/router/fixedassets.js";
import purchaseFixedAssetItemsRouter from "./api/router/purchasefixedassetitems.js";
import fixedAssetAcceptancesRouter from "./api/router/fixedassetacceptances.js";
import esfInboundRouter from "./api/router/esfinbound.js";
...
import classifiersRouter from "./api/router/classifiers.js";
import egovRouter from "./api/router/egov.js";
import govDocsRouter from "./api/router/govdocs.js";
...
app.use("/api/v1", objectMarksRouter);
app.use("/api/v1", todoStatusesRouter);
...
app.use("/api/v1", fixedAssetsRouter);
app.use("/api/v1", purchaseFixedAssetItemsRouter);
app.use("/api/v1", fixedAssetAcceptancesRouter);
app.use("/api/v1", esfInboundRouter);
...
app.use("/api/v1", classifiersRouter);
app.use("/api/v1", egovRouter);
app.use("/api/v1", govDocsRouter);
