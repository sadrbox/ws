...
router.post(`/${ROUTE}`, async (req, res) => {
	try {
		...
		const docNumber = await ensureDocumentNumber({ docType: "outgoing_invoice", modelName: MODEL, manual: req.body.number, organizationUuid, date });
...
router.delete(`/${ROUTE}/:id`, (req, res) =>
	handleDelete({ req, res, prisma, modelName: MODEL, numberDocType: "outgoing_invoice" }),
);
router.post(`/${ROUTE}/batch-delete`, (req, res) =>
	handleBatchDelete({ req, res, prisma, modelName: MODEL, numberDocType: "outgoing_invoice" }),
);
