...
router.put(`/${ROUTE}/:id`, async (req, res) => {
	try {
		...
		{
			const _num = await ensureDocumentNumber({ docType: "payment_invoice", modelName: MODEL, manual: data.number, existingNumber: _ex?.number, organizationUuid: data.organizationUuid ?? _ex?.organizationUuid, date: data.date ?? _ex?.date, excludeUuid: _ex?.uuid });
