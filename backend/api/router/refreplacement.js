...
const MODEL_CONFIG = {
	unitOfMeasure: { displayField: "name", label: "Единицы измерения" },
	tax: { displayField: "name", label: "Налоги" },
	brand: { displayField: "name", label: "Бренды" },
	currency: { displayField: "name", label: "Валюты" },
	warehouse: { displayField: "name", label: "Склады" },
	employee: { displayField: "fullName", label: "Сотрудники" },
	position: { displayField: "name", label: "Должности" },
	counterparty: { displayField: "name", label: "Контрагенты" },
	organization: { displayField: "name", label: "Организации" },
};
