...
// ВНИМАНИЕ: счётчики живут в памяти воркера. ecosystem.config.js предусматривает
// cluster на 4 воркера — в этом режиме фактический предел вчетверо выше указанного.
...
// (админка сбрасывает кэш, но в cluster-режиме только в СВОЁМ воркере — остальные ждут TTL).
