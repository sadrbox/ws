...
//
// Хранится, а не только летит по шине: шина (services/chatBus.js) живёт в памяти процесса, а
// backend в production работает кластером — событие, опубликованное в одном процессе, не
// дойдёт до клиента, подключённого к другому. Панель поэтому ещё и опрашивает непрочитанные
