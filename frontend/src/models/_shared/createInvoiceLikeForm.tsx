...
export function createInvoiceLikeForm(cfg: InvoiceLikeFormConfig): FC<Partial<TPane>> {
  const Form: FC<Partial<TPane>> = (paneProps) => {
    ...
    const form = useFormStore<TFields>({
      ...
      buildPayload: (fd) => {
        const validation = validatePostedDocument(cfg.docType, fd as Record<string, any>, fd.posted === true);
    ...
    return (
      <FormRequiredScope docType={cfg.docType} isPosted={form.fields.posted === true}>
