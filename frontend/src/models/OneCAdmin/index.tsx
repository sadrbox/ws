 ...
 * наблюдение: ход запросов и команд, журнал заданий и доска сообщений. Раньше «Прогресс»
 * жил внутри вкладки «Пользователи баз» и пропадал при переходе на любую другую, хотя
 * операция продолжала идти; а сообщения вставлялись над таблицами и двигали их вниз под
 * курсором. Теперь наблюдение видно всегда и не отнимает места у работы.
 *
