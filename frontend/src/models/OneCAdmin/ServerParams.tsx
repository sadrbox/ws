 ...
 *
 * Мест два: экран «Настройки» (все серверы разом) и вкладка «Параметры» в карточке агента
 * (сервер этого агента). Поля одни и те же, и держать два редактора значило бы получить
 * две правды об одном: где-то поле есть, где-то нет, где-то очищается, где-то нет.
 *
