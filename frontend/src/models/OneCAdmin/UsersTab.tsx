 ...
 * только таблицы, поэтому появление сообщения ничего не сдвигает. Обёртки-каркаса у экрана
 * нет: вкладка и так колонка флекса, и три блока лежат в ней напрямую — как таблица в
 * остальных вкладках панели.
 */
