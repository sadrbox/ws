...
const headCellStyle: CSSProperties = {
  ...cellStyle, background: "#f3f3f3", fontWeight: 600, textAlign: "center", fontSize: "8pt",
};

const SalesReturnPrint: FC<{ data: SaleInvoicePrintData }> = ({ data }) => {
  ...
  return (
    <A4Page>
      <A4DocTitle subtitle={`№ ${docNumber} от ${docDate}`}>
        АКТ ВОЗВРАТА ТОВАРОВ ОТ ПОКУПАТЕЛЯ
      </A4DocTitle>

      <div style={{ display: "flex", flexDirection: "column", gap: "3mm", fontSize: "9pt" }}>
        <A4Row>
          <A4Field label="Продавец (принимает возврат)" width="50%">
      ...
      <div style={{ marginTop: "8mm", display: "flex", justifyContent: "space-between", gap: "12mm" }}>
        <A4Signature role="Продавец (принял)" />
