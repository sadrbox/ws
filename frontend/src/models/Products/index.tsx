  ...
  const form = useFormStore<TFields>({
    ...
    tables: {
      barcodes: {
        ...
        createPayload: (r: TDataItem) => ({ barcode: r.barcode ?? "", comment: r.comment ?? null }),
        updatePayload: (r: TDataItem) => ({ barcode: r.barcode ?? "", comment: r.comment ?? null }),
      },
      prices: {
        endpoint: "product-prices", parentField: "productUuid",
        label: translate("prices"),
        batchEndpoint: "product-prices/batch",
        createPayload: (r: TDataItem) => ({ date: r.date ?? null, priceTypeUuid: r.priceTypeUuid ?? null, price: r.price ?? null }),
