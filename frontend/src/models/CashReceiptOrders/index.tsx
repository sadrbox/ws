...
interface CashReceiptOrdersListProps { variant?: TTableVariant; onSelectItem?: (item: TDataItem) => void; ownerUuid?: string; ownerField?: string; }

const CashReceiptOrdersList: FC<CashReceiptOrdersListProps> = ({ variant = "default", onSelectItem, ownerUuid, ownerField } = {}) => {
