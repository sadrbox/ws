...
const CashReceiptOrdersForm: FC<Partial<TPane>> = (paneProps) => {
...
const CashReceiptOrdersList: FC<{ variant?: TTableVariant; onSelectItem?: (item: TDataItem) => void; ownerUuid?: string; ownerField?: string }> = (
...
CashReceiptOrdersList.displayName = LIST_NAME;
