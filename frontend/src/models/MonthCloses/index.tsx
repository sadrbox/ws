  ...
  const headerActionsPortal = usePaneHeaderActions(
    ...
    (
      <>
        ...
        {isSavedDoc && <><DocumentEntriesButton documentType={DOC_TYPE} documentUuid={form.fields.uuid} /> <NotesButton endpoint={ENDPOINT} uuid={form.fields.uuid} /> <CreateTaskButton endpoint={ENDPOINT} uuid={form.fields.uuid} /> <ShowInJournalButton endpoint={ENDPOINT} uuid={form.fields.uuid} /> <DeleteDocumentButton endpoint={ENDPOINT} uuid={form.fields.uuid} paneId={form.paneId} /></>}
      </>
    ),
  );
