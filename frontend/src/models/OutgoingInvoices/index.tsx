...
interface OutgoingInvoicesListProps { variant?: TTableVariant; onSelectItem?: (item: TDataItem) => void; ownerUuid?: string; ownerField?: string; }

const OutgoingInvoicesList: FC<OutgoingInvoicesListProps> = ({ variant = "default", onSelectItem, ownerUuid, ownerField } = {}) => {
