...
interface BrandsListProps { variant?: TTableVariant; onSelectItem?: (item: TDataItem) => void; }

const BrandsList: FC<BrandsListProps> = ({ variant = "default", onSelectItem } = {}) => {
  ...
  const openModelForm = useCallback((formProps: TOpenModelFormProps) => {
    ...
    addPane({
      ...
      component: BrandsForm, data: d, onSave: () => refetch(), onClose: () => refetch(),
    });
