...
interface IncomingInvoicesListProps { variant?: TTableVariant; onSelectItem?: (item: TDataItem) => void; ownerUuid?: string; ownerField?: string; }

const IncomingInvoicesList: FC<IncomingInvoicesListProps> = ({ variant = "default", onSelectItem, ownerUuid, ownerField } = {}) => {
