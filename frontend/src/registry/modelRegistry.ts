...
const MODEL_REGISTRY: ModelRegistryEntry[] = [
	...
	},
	{
		...
		module: () => import("src/models/StockCounts"),
		formName: "StockCountsForm",
		listName: "StockCountsList",
		storageKey: "stock-counts-form",
		label: "Инвентаризация",
	},
	{
		endpoint: "goodsreceipts",
		module: () => import("src/models/GoodsReceipts"),
		formName: "GoodsReceiptsForm",
		listName: "GoodsReceiptsList",
		storageKey: "goods-receipts-form",
		label: "Оприходование товара",
	},
	{
		endpoint: "serialnumbers",
		module: () => import("src/models/SerialNumbers"),
		formName: "SerialNumbersForm",
		listName: "SerialNumbersList",
		storageKey: "serial-numbers-form",
		label: "Серийные номера",
	},
	{
		endpoint: "writeoffs",
		module: () => import("src/models/WriteOffs"),
		formName: "WriteOffsForm",
		listName: "WriteOffsList",
		storageKey: "write-offs-form",
	...
	},
	{
		...
		listName: "CommercialOffersList",
		storageKey: "commercial-offers-form",
		label: "Коммерческие предложения",
	},
	{
		endpoint: "sales-orders",
		module: () => import("src/models/SalesOrders"),
		formName: "SalesOrdersForm",
		listName: "SalesOrdersList",
		storageKey: "sales-orders-form",
		label: "Заказы покупателей",
	},
	{
		endpoint: "reservations",
		module: () => import("src/models/Reservations"),
		formName: "ReservationsForm",
		listName: "ReservationsList",
		storageKey: "reservations-form",
		label: "Резервирование товара",
	},
	{
		endpoint: "purchase-orders",
		module: () => import("src/models/PurchaseOrders"),
		formName: "PurchaseOrdersForm",
		listName: "PurchaseOrdersList",
		storageKey: "purchase-orders-form",
		label: "Заказы поставщикам",
	},
	{
		endpoint: "bank-statements",
		module: () => import("src/models/BankStatements"),
		formName: "BankStatementsForm",
		listName: "BankStatementsList",
