	...
	return (
		<article className={styles.Row} data-type={m.type} data-past={!m.active || undefined}>
			...
			<div className={styles.RowBody}>
				...
				<div className={styles.MsgMeta}>
					...
					{/*
					  ...
					  * формы, а не запись в журнале: убранная, она не вернётся, пока форма
					  * говорит то же самое, но изменившееся состояние форма покажет снова.
					  */}
			...
			{/*
			  ...
			  *
			  * У ЖИВОГО СООБЩЕНИЯ КНОПКА ТОЖЕ ЕСТЬ. Раньше её не было («форма скажет снова»), и
			  * такие строки было не убрать ничем. Теперь убранная строка формы не возвращается,
			  * пока форма говорит то же самое (store.hidden); изменилось — покажется снова.
			  */}
