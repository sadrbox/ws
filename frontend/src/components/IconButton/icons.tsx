...
/**
 * Перезаполнить по основанию — «документ → документ»: лист-основание слева вверху,
 * изогнутая стрелка к листу-приёмнику справа внизу. Пиксельная сетка: только целые
 * прямоугольники, стрелка — диагональ лесенкой, без полутонов по краям.
 */
export const SyncFromBasisIcon: FC<SvgProps> = (props) => (
  <svg {...baseProps} {...props}>
    <path d="M1 1h6v8H1V1Zm1 1v6h4V2H2Z" />
    <path d="M3 3h2v1H3V3Zm0 2h2v1H3V5Z" />
    <path d="M9 7h6v8H9V7Zm1 1v6h4V8h-4Z" />
    <path d="M11 9h2v1h-2V9Zm0 2h2v1h-2v-1Z" />
    <path d="M4 10h1v3H4v-3Zm1 2h3v1H5v-1Z" />
    <path d="M6 10h1v1H6v-1Zm1 1h1v1H7v-1Zm1 1h1v1H8v-1ZM7 13h1v1H7v-1Zm-1 1h1v1H6v-1Z" />
  </svg>
);
