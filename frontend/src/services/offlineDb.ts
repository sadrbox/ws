...
class OfflineDatabase extends Dexie {
  ...
  constructor() {
    ...
    this.version(2).stores({
      ...
      contracts:           "++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, shortName",
      contacts:            "++id, &uuid, updatedAt, deletedAt, contactTypeUuid, ownerType, ownerUuid",
      contacttypes:        "++id, &uuid, updatedAt, deletedAt, shortName",
      contactpersons:      "++id, &uuid, updatedAt, deletedAt, ownerType, ownerUuid, fullName",
      bankaccounts:        "++id, &uuid, updatedAt, deletedAt, ownerType, ownerUuid, currencyUuid, iban",
      users:               "++id, &uuid, updatedAt, deletedAt, username, email, employeeUuid, organizationUuid",
      todos:               "++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, curatorUuid, executorUuid, status",
      notifications:       "++id, &uuid, updatedAt, deletedAt, userUuid, todoUuid, isRead",
      warehouses:          "++id, &uuid, updatedAt, deletedAt, organizationUuid, shortName",
      sales:               "++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, contractUuid, documentDate, status",
      purchases:           "++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, contractUuid, documentDate, status",
      "outgoing-invoices": "++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, contractUuid, documentDate, status",
      "incoming-invoices": "++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, contractUuid, documentDate, status",
      "payment-invoices":  "++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, contractUuid, documentDate, status",
      "scheduled-tasks":   "++id, &uuid, updatedAt, deletedAt, organizationUuid, status",
      "inventory-transfers":"++id, &uuid, updatedAt, deletedAt, organizationUuid, fromWarehouseUuid, toWarehouseUuid, documentDate",
      "cash-receipt-orders":"++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, contractUuid, documentDate, status",
      "cash-expense-orders":"++id, &uuid, updatedAt, deletedAt, organizationUuid, counterpartyUuid, contractUuid, documentDate, status",
      ...
      employees:           "++id, &uuid, updatedAt, deletedAt, organizationUuid, fullName, iin",
      positions:           "++id, &uuid, updatedAt, deletedAt, shortName",
      "employee-histories":"++id, &uuid, updatedAt, deletedAt, employeeUuid, positionUuid, organizationUuid",
    ...
    this.version(3).stores({
      "payroll-calculations": "++id, &uuid, updatedAt, deletedAt, employeeUuid, organizationUuid, positionUuid, period, status",
      "payroll-payments":  "++id, &uuid, updatedAt, deletedAt, employeeUuid, organizationUuid, period, status",
    });
  }
...
export async function ensureOfflineDb(): Promise<OfflineDatabase> {
  ...
  try {
    ...
    if (
      ...
      console.warn("[OfflineDB] Upgrade error — deleting and recreating database...", err.message);
      try { await Dexie.delete("app_offline_db"); } catch { /* ignore */ }
...
export async function setLastSyncAt(table: string, timestamp: string): Promise<void> {
...
export async function getPendingChangesByTable(table: string): Promise<PendingChange[]> {
