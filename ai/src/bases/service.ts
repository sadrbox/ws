...
export function ibFailureReason(
	...
	// Конфликт блокировок (17.09): в базу вошли, запись не дождалась чужой транзакции — база исправна.
	if (/конфликт блокировок|время ожидания предоставления блокировки|взаимоблокировк|lock conflict|deadlocked/i.test(text)) return null;
